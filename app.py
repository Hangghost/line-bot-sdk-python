...
def linebot():
    ...
    try:
        access_token = os.putenv('LINE_ACCESS_TOKEN')
        secret = os.putenv('LINE_SECRET')
        openai.api_type = "azure"
        openai.api_base = os.putenv('AZURE_OPENAI_ENDPOINT')
        openai.api_version = "2023-03-15-preview"
        openai.api_key = os.putenv('AZURE_OPENAI_KEY')
